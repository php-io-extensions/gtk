...
#include "src/gtk-flow-box-child.h"
...
{
	ZEPHIR_REGISTER_CLASS(Gtk\\Gtk\\GtkFlowBoxChild, GtkFlowBoxChild, gtk_gtk, gtkflowboxchild_gtkflowboxchild, gtk_gtk_gtkflowboxchild_gtkflowboxchild_method_entry, 0);
...
PHP_METHOD(Gtk_Gtk_GtkFlowBoxChild_GtkFlowBoxChild, new_)
{
	...
	RETURN_LONG(phpgtk_gtkflowboxchild_new());
}
...
PHP_METHOD(Gtk_Gtk_GtkFlowBoxChild_GtkFlowBoxChild, changed)
{
	...
	ZVAL_LONG(&_0, handle);
	phpgtk_gtkflowboxchild_changed(&_0);
}
...
PHP_METHOD(Gtk_Gtk_GtkFlowBoxChild_GtkFlowBoxChild, getChild)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(phpgtk_gtkflowboxchild_get_child(&_0));
}
...
PHP_METHOD(Gtk_Gtk_GtkFlowBoxChild_GtkFlowBoxChild, getIndex)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(phpgtk_gtkflowboxchild_get_index(&_0));
}
...
PHP_METHOD(Gtk_Gtk_GtkFlowBoxChild_GtkFlowBoxChild, isSelected)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	r = phpgtk_gtkflowboxchild_is_selected(&_0);
	RETURN_BOOL(r == 1);
}
...
PHP_METHOD(Gtk_Gtk_GtkFlowBoxChild_GtkFlowBoxChild, setChild)
{
	...
	ZVAL_LONG(&_0, handle);
	ZVAL_LONG(&_1, child);
	phpgtk_gtkflowboxchild_set_child(&_0, &_1);
}
