...
zend_class_entry *gtk_gdk_gdkglcontext_gdkglcontext_ce;
zend_class_entry *gtk_gdk_gdkkeyval_gdkkeyval_ce;
...
zend_class_entry *gtk_gio_gsimpleactiongroup_gsimpleactiongroup_ce;
...
zend_class_entry *gtk_gtk_gtkcalendar_gtkcalendar_ce;
zend_class_entry *gtk_gtk_gtkcenterbox_gtkcenterbox_ce;
zend_class_entry *gtk_gtk_gtkcheckbutton_gtkcheckbutton_ce;
zend_class_entry *gtk_gtk_gtkcolumnview_gtkcolumnview_ce;
zend_class_entry *gtk_gtk_gtkcolumnviewcolumn_gtkcolumnviewcolumn_ce;
zend_class_entry *gtk_gtk_gtkcssprovider_gtkcssprovider_ce;
...
zend_class_entry *gtk_gtk_gtkeventcontroller_gtkeventcontroller_ce;
zend_class_entry *gtk_gtk_gtkeventcontrollerkey_gtkeventcontrollerkey_ce;
zend_class_entry *gtk_gtk_gtkeventcontrollermotion_gtkeventcontrollermotion_ce;
zend_class_entry *gtk_gtk_gtkeventcontrollerscroll_gtkeventcontrollerscroll_ce;
...
zend_class_entry *gtk_gtk_gtkgesture_gtkgesture_ce;
zend_class_entry *gtk_gtk_gtkgestureclick_gtkgestureclick_ce;
zend_class_entry *gtk_gtk_gtkgesturesingle_gtkgesturesingle_ce;
zend_class_entry *gtk_gtk_gtkglarea_gtkglarea_ce;
...
zend_class_entry *gtk_gtk_gtklistitem_gtklistitem_ce;
zend_class_entry *gtk_gtk_gtkmediafile_gtkmediafile_ce;
zend_class_entry *gtk_gtk_gtkmediastream_gtkmediastream_ce;
zend_class_entry *gtk_gtk_gtknoselection_gtknoselection_ce;
...
zend_class_entry *gtk_gtk_gtkselectionmodel_gtkselectionmodel_ce;
zend_class_entry *gtk_gtk_gtkseparator_gtkseparator_ce;
zend_class_entry *gtk_gtk_gtksignallistitemfactory_gtksignallistitemfactory_ce;
zend_class_entry *gtk_gtk_gtksingleselection_gtksingleselection_ce;
...
zend_class_entry *gtk_gtk_gtkstylecontext_gtkstylecontext_ce;
...
zend_class_entry *gtk_gtk_gtkvideo_gtkvideo_ce;
...
static PHP_MINIT_FUNCTION(gtk)
{
	...
	ZEPHIR_INIT(Gtk_Gdk_GdkGLContext_GdkGLContext);
	ZEPHIR_INIT(Gtk_Gdk_GdkKeyval_GdkKeyval);
	...
	ZEPHIR_INIT(Gtk_Gio_GSimpleActionGroup_GSimpleActionGroup);
	...
	ZEPHIR_INIT(Gtk_Gtk_GtkCalendar_GtkCalendar);
	ZEPHIR_INIT(Gtk_Gtk_GtkCenterBox_GtkCenterBox);
	ZEPHIR_INIT(Gtk_Gtk_GtkCheckButton_GtkCheckButton);
	ZEPHIR_INIT(Gtk_Gtk_GtkColumnViewColumn_GtkColumnViewColumn);
	ZEPHIR_INIT(Gtk_Gtk_GtkColumnView_GtkColumnView);
	ZEPHIR_INIT(Gtk_Gtk_GtkCssProvider_GtkCssProvider);
	...
	ZEPHIR_INIT(Gtk_Gtk_GtkEventControllerKey_GtkEventControllerKey);
	ZEPHIR_INIT(Gtk_Gtk_GtkEventControllerMotion_GtkEventControllerMotion);
	ZEPHIR_INIT(Gtk_Gtk_GtkEventControllerScroll_GtkEventControllerScroll);
	ZEPHIR_INIT(Gtk_Gtk_GtkEventController_GtkEventController);
	...
	ZEPHIR_INIT(Gtk_Gtk_GtkGLArea_GtkGLArea);
	ZEPHIR_INIT(Gtk_Gtk_GtkGestureClick_GtkGestureClick);
	ZEPHIR_INIT(Gtk_Gtk_GtkGestureSingle_GtkGestureSingle);
	ZEPHIR_INIT(Gtk_Gtk_GtkGesture_GtkGesture);
	...
	ZEPHIR_INIT(Gtk_Gtk_GtkListItem_GtkListItem);
	ZEPHIR_INIT(Gtk_Gtk_GtkMediaFile_GtkMediaFile);
	ZEPHIR_INIT(Gtk_Gtk_GtkMediaStream_GtkMediaStream);
	ZEPHIR_INIT(Gtk_Gtk_GtkNoSelection_GtkNoSelection);
	...
	ZEPHIR_INIT(Gtk_Gtk_GtkSelectionModel_GtkSelectionModel);
	ZEPHIR_INIT(Gtk_Gtk_GtkSeparator_GtkSeparator);
	ZEPHIR_INIT(Gtk_Gtk_GtkSignalListItemFactory_GtkSignalListItemFactory);
	ZEPHIR_INIT(Gtk_Gtk_GtkSingleSelection_GtkSingleSelection);
	...
	ZEPHIR_INIT(Gtk_Gtk_GtkStyleContext_GtkStyleContext);
	...
	ZEPHIR_INIT(Gtk_Gtk_GtkVideo_GtkVideo);
